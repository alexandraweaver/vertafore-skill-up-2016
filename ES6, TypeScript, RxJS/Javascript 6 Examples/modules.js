// Modules aren't quite ready in browsers yet, so you'll need to use some sort of "transpiler" and module loader. The below example is using TypeScript as the transpiler and SystemJS as the module loader.

//Modules allow you to export from one file to import in another allowing you to easily organize the file structure of your project and eventually enabling "lazy loading" of JavaScript modules.

// Modules will also be how you work with 3rd party libraries (Angular, React, etc) in your application code.
